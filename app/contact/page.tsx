        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-2xl overflow-hidden shadow-md">
              <div className="w-full h-64 bg-brand-line/15 dark:bg-gray-700 shadow-inner flex items-center justify-center">
                <div className="text-center">
                  <MapPin className="w-12 h-12 text-brand-ink/50 dark:text-gray-400 mx-auto mb-2" />
                  <p className="font-body text-brand-ink/70 dark:text-gray-300">
                    Map: Indirapuram, Ghaziabad
                  </p>
                  <p className="font-body text-sm text-brand-ink/50 dark:text-gray-400 mt-1">
